...
interface TodoFormData {
  initialFormData?: TodoFormInterface;
  handleSave: (formData: TodoFormInterface) => void;
}

function TodoForm({ initialFormData = defaultInitialFormData, handleSave }: TodoFormData): JSX.Element {
